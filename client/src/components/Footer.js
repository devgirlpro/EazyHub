...
<div class="w-full sticky top-[100vh] flex  justify-center">
        <div class="md:w-2/3 w-full px-4 text-white flex flex-col">

            <div class="flex flex-col">
                <div class="flex mt-0 mb-5 flex-row justify-between">
              
                <img src={logo} alt="logo" className="w-32 cursor-pointer" />

                    {/* <a href="/" class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Home</a>
                    <a href="/about" class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">About us</a>
                    <a href="/contact" class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Contact</a>
                    <a href="/login" class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Login</a> */}
                    <div class="flex flex-row space-x-8 items-center justify-between">
                        <a>

                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" fill="white"/></svg>                          
                        </a>
                        <a>
                        ...
                        <a href="https://www.youtube.com/channel/123">
                ...
                <p class="w-full text-center my-6 text-gray-600">Copyright © 2022 EazyHub</p>
            </div>
        </div>
    </div>
